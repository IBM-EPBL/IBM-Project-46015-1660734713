...
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=98538591-7217-4024-b027-8baa776ffad1.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud;PORT=30875;SECURITY=SSL;SSLServerCertificate=abc.crt;UID=mwk61981;PWD=EawUZFLgNcnQA2zI",'','')
print(conn)
...
def requestBloodPlasma():
    ...
    message = Mail(
        from_email='eswaramoorthym2@gmail.com',
